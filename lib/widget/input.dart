...
class InputField extends StatelessWidget {
  ...
  final int?
      maxLines; // Optional: to adjust how many lines the textarea can expand to
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          validator: validator,
          maxLines:
              effectiveMaxLines, // Adjust how many lines the input field can have
          minLines:
              effectiveMinLines, // Adjust the minimum number of lines (height)
