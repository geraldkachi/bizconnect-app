...
class ExploreProductsPage extends ConsumerStatefulWidget {
  const ExploreProductsPage({
    super.key,
  });

  @override
  ConsumerState<ExploreProductsPage> createState() => _ExploreProductsPageState();
}

class _ExploreProductsPageState extends ConsumerState<ExploreProductsPage> {
  @override
