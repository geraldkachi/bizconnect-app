...
class DiscoverBusinessPage extends ConsumerStatefulWidget {
  const DiscoverBusinessPage({
    super.key,
  });

  @override
  ConsumerState<DiscoverBusinessPage> createState() => _DiscoverBusinessPageState();
}

class _DiscoverBusinessPageState extends ConsumerState<DiscoverBusinessPage> {
  @override
